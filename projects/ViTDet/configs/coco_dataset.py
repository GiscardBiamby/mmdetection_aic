...
with read_base():
    ...
    from ....configs._base_.default_runtime import *  # noqa: F401,F403,W0401


from mmdet.datasets import CocoDatasetGSD
from projects.ViTDet.vitdet.util import AddInputRes
...
# This config seems broken? It fails with coco_gsd.py line 1 (super(CocoDatasetSGD,
# self).__init__()); `assert input_res in img``
