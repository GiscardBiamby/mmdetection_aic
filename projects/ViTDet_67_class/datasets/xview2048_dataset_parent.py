...
with read_base():
    ...
    from .xview400_dataset_parent import *  # noqa: F401,F403,W0401,W0614
...
#     │       └── xview_coco_val.json
data_root = "data/xview/chipped/2048_0"
...
train_dataloader.merge(
    dict(
        ...
        dataset=dict(
            data_root=data_root,
            ann_file="xview_coco_train_2048_0_7classes-parent_level.json",
            data_prefix=dict(img="xview_coco_train_images_2048_0/"),
        ),
    )
)
...
val_dataloader.merge(
    dict(
        ...
        dataset=dict(
            data_root=data_root,
            ann_file="xview_coco_val_2048_0_7classes-parent_level.json",
            data_prefix=dict(img="xview_coco_val_images_2048_0/"),
        ),
    )
)
