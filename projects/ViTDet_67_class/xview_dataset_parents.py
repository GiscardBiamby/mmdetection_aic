...
# enclave_scripts/scripts/slice_xview.sh, which is `data/xview/chipped/...`
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        ann_file="xview_coco_train_400_0_67classes_parents.json",
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        metainfo=dict(classes=CLASSES),
        data_root=data_root,
        ann_file="xview_coco_val_400_0_67classes_parents.json",
