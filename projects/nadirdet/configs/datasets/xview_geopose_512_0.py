...
# dataset settings
dataset_type = "XViewGeoPoseDataset"
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            ann_file="xview_coco_train_512_0_augmented.json",
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file="xview_coco_val_512_0_augmented.json",
...
val_evaluator = dict(
    ...
    ann_file=data_root + "xview_coco_val_512_0_augmented.json",
    metric=["bbox"],
    format_only=False,
    backend_args=backend_args,
